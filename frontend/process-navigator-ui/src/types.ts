...
export type BusinessDirection = { id: string; name: string; description: string; icon: string; processIds: string[] };
export type OrganizationUnit = { id: string; parentId?: string; name: string; shortName: string; managerPosition: string };
export type LegalEntity = { id: string; name: string; description: string; directions: BusinessDirection[]; units?: OrganizationUnit[] };
export type LaneOrganization = { laneId: string; legalEntityId: string; department: string; unitId?: string };
export type CrossCompanyProcess = { processId: string; legalEntityIds: string[]; laneOrganizations: LaneOrganization[]; description: string };
export type OrganizationMap = { id: string; name: string; description: string; legalEntities: LegalEntity[]; crossCompanyProcesses: CrossCompanyProcess[] };
...
export type UserProfile = { id: string; displayName: string; role: string; roleName: string; permissions: string[]; isActive: boolean; legalEntityId?: string; unitId?: string; position?: string };
...
export type UserUpdate = { displayName: string; role: string; isActive: boolean; legalEntityId?: string; unitId?: string; position?: string };
...
export type OneCIntegrationSettings = { enabled: boolean; baseUrl: string; healthPath: string; commandPath: string; username: string; passwordConfigured: boolean; timeoutSeconds: number };
export type OneCIntegrationUpdate = Omit<OneCIntegrationSettings, 'passwordConfigured'> & { password?: string };
export type OneCConnectionStatus = { connected: boolean; mode: string; message: string; checkedAt: string };
