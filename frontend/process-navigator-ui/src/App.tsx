...
import { Activity, BarChart3, Bell, BriefcaseBusiness, ChevronRight, CircleHelp, FilePenLine, History, Home, Maximize2, Minus, PencilRuler, PlugZap, Plus, Rocket, RotateCcw, Search, Upload, UserCog, Users } from 'lucide-react';
