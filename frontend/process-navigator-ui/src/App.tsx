...
import { Activity, BarChart3, Bell, BriefcaseBusiness, ChevronRight, CircleHelp, FilePenLine, History, Home, Maximize2, Minus, PencilRuler, Plus, Rocket, RotateCcw, Search, Upload, UserCog, Users } from 'lucide-react';
import { createDraft, loadArchivedProcess, loadAssignments, loadNotifications, loadProcess, loadProcessCatalog, loadSession, markAllNotificationsRead, markNotificationRead, publishDraft, setActiveUser, updateStep } from './api';
