...
import { Activity, BriefcaseBusiness, ChevronRight, FilePenLine, History, Home, Maximize2, Minus, PencilRuler, Plus, Rocket, RotateCcw, Search, Upload, UserCog, Users } from 'lucide-react';
