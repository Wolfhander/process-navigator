...
import { BriefcaseBusiness, ChevronRight, FilePenLine, History, Home, Maximize2, Minus, PencilRuler, Plus, Rocket, RotateCcw, Search, Upload, UserCog, Users } from 'lucide-react';
import { createDraft, loadArchivedProcess, loadAssignments, loadProcess, loadProcessCatalog, loadSession, publishDraft, setActiveUser } from './api';
...
import type { ProcessAssignments, ProcessImportResult, ProcessModel, ProcessNode, ProcessSummary, Session } from './types';
...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    {assignmentsOpen && assignments && <AssignmentDialog assignments={assignments} onClose={() => setAssignmentsOpen(false)} onSaved={updated => { setAssignments(updated); setAssignmentsOpen(false); notify('Ответственные по дорожкам сохранены'); }}/>}
  </div>;
}
