...
export function ContextEditor({ processId, node, onCancel, onSaved }: {
  ...
  return <form className="context-editor" onSubmit={submit}>
    ...
    <section className="context-collection"><div className="collection-heading"><h3>Материалы и шаблоны</h3><button type="button" onClick={() => setArtifacts(items => [...items, { name: '', kind: 'Инструкция', version: '1.0', reference: '' }])}><Plus size={15}/>Добавить</button></div>
